...
const translations = {
  ...
  DE: {
    ...
    skinWaiting: 'Laden Sie ein Foto hoch, um die professionelle Hautanalyse zu starten',
      ...
      >
        ...
        <div>
          ...
          <button
            ...
            style={{
              width: '100%',
              marginTop: '24px',
              background: 'linear-gradient(90deg,#7b2cff 0%,#ff00aa 100%)',
              border: 'none',
              color: 'white',
              fontSize: '22px',
              fontWeight: '800',
          ...
          >
            <h3 style={{ marginBottom: '22px', fontSize: '24px' }}>
              {t.stepsTitle}
            </h3>
            ...
            >
              {[t.step1, t.step2, t.step3].map((step, index) => (
                <div key={index} style={{ flex: 1, textAlign: 'center' }}>
                  ...
                  <div style={{ color: '#d4d4d4', lineHeight: '1.5' }}>
                    {step}
                  </div>
                </div>
              ))}
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            ...
            {[
              ...
              >
                ...
                >
                  ...
                  <span
                    style={{
                      color: label === t.irritation ? '#66ff99' : '#ff4fd8',
                    }}
                  >
                    {value}/100
                  </span>
          ...
          >
            ...
            <ul style={{ lineHeight: '2', color: '#e8e8e8', fontSize: '18px' }}>
              {language === 'RU' && (
                <>
          ...
          <>
            ...
            >
              <InfoBlock title={t.professionalInterpretation}>
                {skinAnalysis.interpretation}
              </InfoBlock>

              <ListBlock title={t.skinStrategy} items={skinAnalysis.strategies} />
              ...
              <ListBlock title={t.professionalCare} items={skinAnalysis.care} />
            </div>
          </>
        )}
      </section>
