...
function getGoalBoosts(input = {}) {
  ...
  if (
    ...
    boosts.PIGMENT_CONTROL = 35
    boosts.VITAMIN_C_GLOW = 15
  }
  ...
  if (
    ...
    boosts.VITAMIN_C_GLOW = 40
    boosts.CELL_ACTIVATION = 15
  }
...
function filterBarrierOverreaction(strategies, input = {}) {
  ...
  return strategies.map((strategy) => {
    ...
    if (!hasRealBarrierProblem) {
      return {
        ...strategy,
        priority: Math.min(strategy.priority, 68),
      }
    }
