export function buildExpertDecision(input = {}) {
  ...
  // First stabilise the barrier, then correct age or pigment concerns.
  ...
  // 5. Hydration-only case.
  else if (dehydrated) {
    primary = 'GLACIAR'
  }

  // 6. Cellular activation / regeneration / early age prevention.
  else if (hasCellActivation || hasDullSkin) {
    primary = 'CELL'
  }

  // 7. Vitamin C / antioxidant glow.
